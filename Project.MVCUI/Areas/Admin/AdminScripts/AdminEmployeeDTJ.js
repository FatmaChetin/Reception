...
function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Çalışan bilgisi:</td><td> <a title="Icerik" href="/Admin/Employee/ListEmployees/' + aData[1] + '">  ' + aData[2] + '    </a> </td></tr>';
    sOut += '<tr><td>Çalışan Detayları:</td><td>  <a title="Detay" href="/Admin/EmployeeProfile/ListEmployeeProfiles/' + aData[1] + '"> ' + aData[2] + ' </a>    </td></tr>';
